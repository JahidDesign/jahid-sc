...
const BlogpostHomeCard = () => {
  ...
  const handleReadArticle = async (blogId) => {
    try {
      ...
      setBlogs((prev) =>
        prev.map((b) => (b._id === blogId ? { ...b, views: (b.views || 0) + 1 } : b))
      );
    } catch (err) {
      console.error(err);
    }
    navigate(`/articles/${blogId}`);
  };
  ...
  // 🔹 Return null if loading, error, or no blogs
                ...
                <div className="lg:col-span-5 p-8 lg:p-12 flex flex-col justify-center">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      />
                      <div>
                        <p className="font-semibold text-black">{currentBlogs[0].author}</p>
            ...
            >
              ...
              <div className="p-6 pb-20">
                <div className="mb-4">
                  ...
                  <p className="text-gray-600 line-clamp-3 mb-4 leading-relaxed">{blog.details}</p>
                </div>
                ...
                <div className="flex items-center justify-between text-sm text-gray-500 mb-4">
                  ...
                  <div className="flex items-center gap-4">
                    <VisitorCountHome blogIds={blog._id} initialCount={blog.views} />
